...
// Route::get('/fetch-media-categories', [MicroManagePhotoGalleryController::class, 'fetchMediaCategories'])->name('fetchMediaCategories');
Route::get('/fetchMediaCategories', [MicroManagePhotoGalleryController::class, 'fetchMediaCategories'])->name('fetchMediaCategories');
Route::get('/fetchMediaCategoriesvideo', [MicroVideoGalleryController::class, 'fetchMediaCategoriesvideo'])->name('fetchMediaCategoriesvideo');
...
Route::get('view-pdf/{filename}', [HomeController::class,'viewPDF'])->name('view-pdf');