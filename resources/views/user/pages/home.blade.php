  ...
  <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="false">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
            <img src="{{ asset('assets/images/' . $slider->image) }}" class="d-block w-100 img-fluid h-50" alt="{{ $slider->text }}">
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                ...
                <div class="card mb-4 card-hover">
                    <!-- img -->
                    <div>
                        <img src="assets/images/4.jpg" alt="img" class="card-img-top">
                    </div>
                    <!-- card body -->
                    <div class="card-body">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                ...
                <div class="card mb-4 card-hover">
                    <!-- img -->
                    <div>
                        <img src="assets/images/2.jpg" alt="img" class="card-img-top">
                    </div>
                    <!-- card body -->
                    <div class="card-body">
                      <h3 class="mb-0 fw-semibold"><a href="#" class="text-inherit">Director's Message</a></h3>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                ...
                <div class="card mb-4 card-hover">
                    <!-- img -->
                    <div>
                        <img src="assets/images/3.jpg" alt="img" class="card-img-top">
                    </div>
                    <!-- card body -->
                    <div class="card-body">
                      <h3 class="mb-0 fw-semibold"><a href="#" class="text-inherit">Director's Message</a></h3>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-12 d-lg-none d-xl-block">
                ...
                <div class="card mb-4 card-hover">
                    <!-- img -->
                    <div>
                        <img src="assets/images/5.jpg" alt="img" class="card-img-top">
                    </div>
                    <!-- card body -->
                    <div class="card-body">
                      <h3 class="mb-0 fw-semibold"><a href="#" class="text-inherit">Director's Message</a></h3>
