            ...
            <form action="{{ route('researchcentres.update', $researchCentre->id) }}" method="POST"
                ...
                <div class="row">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="form-group position-relative">
                                <input type="radio" name="language" id="language" value="1"
                                    {{ old('language', $researchCentre->language) == 1 ? 'checked' : '' }}> English
                            ...
                            <div class="form-group position-relative">
                                <select class="form-select form-control h-58" 
                                    ...
                                    <option value="1" class="text-dark"
                                            {{ $researchCentre->texttype == 1 ? 'selected' : '' }}>PDF file Upload</option>
                                    <option value="2" class="text-dark"
                                            {{ $researchCentre->texttype == 2 ? 'selected' : '' }}>Web Site Url</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="pdfField" class="form-group mb-4" style="display: none;">
                        ...
                        <p>Current File: 
                            <a href="{{ asset('storage/' . $researchCentre->pdf) }}" target="_blank">
                                View PDF
                            </a>
                        </p>
                    ...
                    <div id="urlField" class="form-group mb-4" style="display: none;">
                        ...
                        <input type="url" class="form-control h-58" id="websiteUrl" name="websiteUrl" value="{{ $researchCentre->url }}">
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group mb-4">
                            ...
                            <select name="status" id="status" class="form-control" required>
                                ...
                                <option value="1" {{ old('status', $researchCentre->status) == 1 ? 'selected' : '' }}>
                                    Active</option>
...
<script>
    ...
    // Call the function on page load with the pre-selected value
    document.addEventListener("DOMContentLoaded", function() {
        const selectedValue = document.getElementById('texttype').value;
