                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group mb-4">
                                ...
                                <span class="star">*</span>
                                <div class="form-group position-relative">
                                <textarea class="form-control" id="job_description" placeholder="Enter the Job Description" name="job_description" rows="5">{{ old('job_description', $vacancy->job_description) }}</textarea>
                                </div>
                                </div>
                            </div>
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <select class="form-select form-control ps-5 h-58" name="content_type" id="content_type" required>
                                        ...
                                        <option value="PDF" class="text-dark" {{ old('content_type', $vacancy->content_type) == 'PDF' ? 'selected' : '' }}>PDF File Upload</option>
                                        <option value="Website" class="text-dark" {{ old('content_type', $vacancy->content_type) == 'Website' ? 'selected' : '' }}>Website URL</option>
                                    </select>
                                </div>
                            </div>
                        </div>
