                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input class="form-check-input" type="radio" name="language" value="english" {{ $cadre->language == 'English' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="english">
                                        English
                                    </label>
                                    <input class="form-check-input" type="radio" name="language" value="hindi" {{ $cadre->language == 'Hindi' ? 'checked' : '' }}>
