                        ...
                        <div class="col-lg-4">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input class="form-check-input" type="radio" name="language" value="english" {{ $founder->language == 'English' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="english">
                                        English
                                    </label>
                                    <input class="form-check-input" type="radio" name="language" value="hindi" {{ $founder->language == 'Hindi' ? 'checked' : '' }}>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <select class="form-select form-control ps-5 h-58" name="status" id="status" required>
                                        <option value="1" class="text-dark" {{ $founder->status == '1' ? 'selected' : '' }}>Active</option>
                                        <option value="0" class="text-dark" {{ $founder->status == '0' ? 'selected' : '' }}>Inactive</option>
                                    </select>
                                </div>
                            </div>
                        </div>
