                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="radio" name="language" value="1"
                                        {{ $subcategory->language == '1' ? 'checked' : '' }}> English
                                    <input type="radio" name="language" value="2"
                                        {{ $subcategory->language == '2' ? 'checked' : '' }}> Hindi
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <p id="selected-color" class="label">
                                            ...
                                            <input type="text" class="text-muted form-control mt-2" id="color_hex"
                                                name="color_theme"
                                                value="{{ old('color_theme', $subcategory->color_theme) }}">
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <textarea name="description" id="description" rows="3" required
                                        class="form-control text-dark">{{ $subcategory->description }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
