                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="form-group position-relative">
                                            <input type="radio" name="txtlanguage" value="1" {{ $menu->txtlanguage == '1' ? 'checked' : '' }}> English
                                            <input type="radio" name="txtlanguage" value="2" {{ $menu->txtlanguage == '2' ? 'checked' : '' }}> Hindi
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <select class="form-select form-control ps-5 h-58" id="menu_status" name="menu_status" required>
                                            ...
                                            <option value="0" class="text-dark" {{ $menu->menu_status == 0 ? 'selected' : '' }}>Inactive</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
