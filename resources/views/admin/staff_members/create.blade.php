                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="text" class="form-control text-dark  h-58" name="name_in_hindi" id="name_in_hindi"  value="{{ old('name_in_hindi') }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <span class="star">*</span>
                                <div class="form-group position-relative">
                                    <input type="email" class="form-control text-dark  h-58" name="email" id="email"  value="{{ old('email') }}">
                                    @error('email')
                                        <div style="color: red;">{{ $message }}</div>  <!-- Display error if any -->
                                    @enderror
                                </div> 
                        ...
                        <div class="col-lg-12">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                       <textarea name="description" id="description" class="form-control  text-dark"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                       <textarea name="description_in_hindi" id="description_in_hindi" class="form-control  text-dark"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <span class="star">*</span>
                                <div class="form-group position-relative">
                                    <input type="text" class="form-control text-dark  h-58" name="designation" id="designation"  value="{{ old('designation') }}">
                                    @error('designation')
                                        <div style="color: red;">{{ $message }}</div>  <!-- Display error if any -->
                                    @enderror
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="text" class="form-control text-dark  h-58" name="designation_in_hindi" id="designation_in_hindi"  value="{{ old('designation_in_hindi') }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <span class="star">*</span>
                                <div class="form-group position-relative">
                                    <input type="text" class="form-control text-dark  h-58" name="country_code" id="country_code"  value="{{ old('country_code') }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <span class="star">*</span>
                                <div class="form-group position-relative">
                                    <input type="number" class="form-control text-dark  h-58" name="std_code" id="std_code"  value="{{ old('std_code') }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="number" class="form-control text-dark  h-58" name="phone_internal_office" id="phone_internal_office"  value="{{ old('phone_internal_office') }}">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="number" class="form-control text-dark  h-58" name="phone_internal_residence" id="phone_internal_residence" value="{{ old('phone_internal_residence') }}">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <span class="star">*</span>
                                <div class="form-group position-relative">
                                    <input type="number" class="form-control text-dark  h-58" name="phone_pt_office" id="phone_pt_office" value="{{ old('phone_pt_office') }}">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="number" class="form-control text-dark  h-58" name="phone_pt_residence" id="phone_pt_residence" value="{{ old('phone_pt_residence') }}">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <span class="star">*</span>
                                <div class="form-group position-relative">
                                    <input type="number" class="form-control text-dark  h-58" name="mobile" id="mobile" value="{{ old('mobile') }}">
                                    @error('mobile')
                                        <div style="color: red;">{{ $message }}</div>  <!-- Display error if any -->
                                    @enderror
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="text" class="form-control text-dark  h-58" name="abbreviation" id="abbreviation" value="{{ old('abbreviation') }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="text" class="form-control text-dark  h-58" name="rank" id="rank" value="{{ old('rank') }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <select class="form-select form-control  h-58" name="present_at_station" id="present_at_station">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="text" class="form-control text-dark  h-58" name="acm_status_in_committee" 
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <select class="form-select form-control  h-58" name="co_opted_member" id="co_opted_member">
