                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="text" class="form-control text-dark  h-58" name="designation_in_hindi"
                                        id="designation_in_hindi" value="{{ old('designation_in_hindi') }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                                ...
                                <div class="form-group position-relative">
                                    <select class="form-select form-control  h-58" name="present_at_station"
                                        ...
                                        <option value="1" class="text-dark"
                                            {{ old('present_at_station') == '1' ? 'selected' : '' }}>Yes</option>
                                        <option value="0" class="text-dark"
                                            {{ old('present_at_station') == '0' ? 'selected' : '' }}>No</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <select class="form-select form-control  h-58" name="acm_member" id="acm_member">
                                        <option value="1" class="text-dark"
                                            {{ old('acm_member') == '1' ? 'selected' : '' }}>Yes</option>
                                        <option value="0" class="text-dark"
                                            {{ old('acm_member') == '0' ? 'selected' : '' }}>No</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <select class="form-select form-control  h-58" name="co_opted_member"
                                        id="co_opted_member">
                                        <option value="1" class="text-dark"
                                            {{ old('co_opted_member') == '1' ? 'selected' : '' }}>Yes</option>
                                        <option value="0" class="text-dark"
                                            {{ old('co_opted_member') == '0' ? 'selected' : '' }}>No</option>
                                    </select>
                                </div>
                            </div>
                        </div>
