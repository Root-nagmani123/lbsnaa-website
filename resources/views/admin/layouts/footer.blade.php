...
<script src="{{ asset('public/admin_assets/js/apexcharts.min.js') }}"></script>
<script src="{{ asset('public/admin_assets/js/amcharts.js') }}"></script>
<script src="{{ asset('public/admin_assets/js/custom/ecommerce-chart.js') }}"></script>
<script src="{{ asset('public/admin_assets/js/custom/custom.js') }}"></script>
<script src="{{ asset('public/admin_assets/js/ckeditor.js') }}"></script>
