        ...
        <tr data-id="{{ $faculty->id }}" class="sortable-row">
            ...
            <td class="text-center">
                <div class="d-flex justify-content-center align-items-center gap-2">
                    <a href="{{ route('admin.faculty.edit', $faculty->id) }}" class="btn btn-success text-white btn-sm">
                        Edit
                    </a>
                    <form action="{{ route('admin.faculty.destroy', $faculty->id) }}" method="POST" class="m-0">
                        @csrf
                        @method('DELETE')
