                    ...
                    <div class="row">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <textarea name="description" id="description"
                                        class="form-control  text-dark">{{ $faculty->description }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <textarea name="description_in_hindi" id="description_in_hindi"
                                        class="form-control  text-dark">{{ $faculty->description_in_hindi }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <select class="form-select form-control  h-58" name="acm_member"
                                        id="acm_member">
                                        <option value="1" class="text-dark"
