                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="text" class="form-control text-dark  h-58" name="state_name" id="state_name">
                                    @error('state_name')
                        ...
                        <div class="col-lg-4">
                            <div class="form-group mb-4">
                                ...
                                <span class="star">*</span>
                                <div class="form-group position-relative">
                                    <input type="text" class="form-control text-dark  h-58" name="state_name_hindi" id="state_name_hindi">
                        ...
                        <div class="d-flex ms-sm-3 ms-md-0">
                            ...
                            <a href="{{ route('state.index') }}" class="btn btn-secondary text-white">Back</a>
                        </div>
                    </div>
                </form>
