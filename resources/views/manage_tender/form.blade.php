...
<div class="form-group">
    ...
    <select name="status" class="form-control">
        <option value="">Select</option>
        <option value="Draft" {{ old('status', $manageTender->status ?? '') == 'Draft' ? 'selected' : '' }}>Draft</option>
        <option value="Approval" {{ old('status', $manageTender->status ?? '') == 'Approval' ? 'selected' : '' }}>Approval</option>
        <option value="Publish" {{ old('status', $manageTender->status ?? '') == 'Publish' ? 'selected' : '' }}>Publish</option>
    </select>
    @error('status')
        <div class="text-danger">{{ $message }}</div>
    @enderror
