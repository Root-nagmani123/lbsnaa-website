...
<div class="container">
        <div class="error">
            <h1>500</h1>
            <h2>Error</h2>
            <p>Sorry for the inconvenience! An unexpected error occurred. Please refresh the page or try again later :)</p>
                <a href="{{ session('url.previousdata', url('/')) }}" class="btn btn-primary">Go Home</a>
