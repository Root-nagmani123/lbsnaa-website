                    ...
                    <div class="card-body p-4 pt-0">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="profile-img">
                                ...
                                <span class="fs-14"><b>Login ID</b>:- <?php echo e($user->name ?? 'N/A'); ?></span> <br>
                                <span class="fs-14"><b>Email ID</b>:- <?php echo e($user->email ?? 'N/A'); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/hardeep/public_html/lbsnaa-website/resources/views/admin/manage_profile/index.blade.php ENDPATH**/ ?>