...
<div class="row justify-content-center">
    <div class="col-lg-12">
        <div class="card bg-white border-0 rounded-10 mb-4 p-4">
            ...
            <form action="<?php echo e(route('training-programs.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row">
                    ...
                    <div class="d-flex ms-sm-3 ms-md-0">
                        ...
                        &nbsp;
                        <a href="<?php echo e(route('training-programs.index')); ?>" class="btn btn-secondary text-white">Cancel</a>
                    </div>
                </div>
            </form>
        </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lbsnaa-website\resources\views/admin/micro/training_program/create.blade.php ENDPATH**/ ?>