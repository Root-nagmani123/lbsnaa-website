...
<section class="py-6">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <?php else: ?>
                <?php $__currentLoopData = $archives; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-xl-4 col-lg-4 col-md-6 col-12 mb-3">
                    ...
                    <div class="card mb-4 shadow-lg card-lift" style="height:500px;">
                        ...
                        <div class="card-footer" style="border-top:none;">
                            <a href="<?php echo e(route('user.archive_details', ['id' => $news->managenews_id, 'slug' => $news->research_centre_slug])); ?>"
...
<?php echo $__env->make('user.pages.microsites.includes.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/hardeep/public_html/lbsnaa-website/resources/views/user/pages/microsites/archive.blade.php ENDPATH**/ ?>