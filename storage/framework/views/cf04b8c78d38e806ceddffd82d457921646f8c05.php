                ...
                <table class="table align-middle" id="myTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('photo-gallery.edit', $gallery->id)); ?>"
                                    class="btn bg-success text-white btn-sm">Edit</a>
                                <form action="<?php echo e(route('photo-gallery.destroy', $gallery->id)); ?>" method="POST"
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp11\htdocs\lbsnaa-website\resources\views/admin/manage_photo/index.blade.php ENDPATH**/ ?>