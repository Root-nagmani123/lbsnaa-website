                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-outline-primary fw-semibold btn-sm view-slider"
                                    ...
                                    data-category_name="<?php echo e($audio->category_name); ?>"
                                    data-audio_title_en="<?php echo e($audio->audio_title_en); ?>"
                                    data-audio_title_hi="<?php echo e($audio->audio_title_hi); ?>"
                                    data-audio_upload="<?php echo e(asset('uploads/audios/'.$audio->audio_upload)); ?>">
                                    View
                                </button>
                            </td>
                            <td>
        ...
        button.addEventListener('click', function() {
            ...
            modalBody.innerHTML = `<div>
                    ...
                    <p><strong>File:</strong></p>
                        <?php if($audio->audio_upload): ?>
                            <?php if(pathinfo($audio->audio_upload, PATHINFO_EXTENSION) == 'mp3'): ?>
                                <!-- Audio player -->
                                <audio controls class="mb-3" style="width: 100%;">
                                    <source src="<?php echo e(asset('uploads/audios/' . $audio->audio_upload)); ?>" type="audio/mpeg">
                                    Your browser does not support the audio element.
                                </audio>
                            <?php elseif(pathinfo($audio->audio_upload, PATHINFO_EXTENSION) == 'mp4'): ?>
                                <!-- Video player -->
                                <video controls class="img-fluid mb-3" style="width: 100px; height: 100px;">
                                    <source src="<?php echo e(asset('uploads/audios/' . $audio->audio_upload)); ?>" type="video/mp4">
