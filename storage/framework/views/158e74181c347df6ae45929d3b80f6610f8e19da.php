...
<head>
    ...
    <title>
        ...
        <?php else: ?>
        <?php if(isset($title)): ?>
        <?php echo e($title); ?> | Lal Bahadur Shastri National Academy of Administration
        <?php else: ?>
        ...
        <div class="row py-1 align-items-center">
            <div class="col-md-4 d-flex align-items-center" style="font-size: 13px;font-weight:400;">
                <a href="https://www.india.gov.in/" target="_blank" style="font-size: 16px; color: #af2910;"><img
                        class="img-fluid" src="<?php echo e(asset('assets/images/icons/ashok.jpg')); ?>" alt="indian_flag"
            ...
            <div class="col-md-8">
                <ul class="nav justify-content-end align-items-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('user.search')); ?>" data-bs-toggle="tooltip"
                    ...
                    <!-- <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="languageDropdown">
                            <li><a class="dropdown-item" href="<?php echo e(route('set.language', 1)); ?>" aria-label="English">English</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('set.language', 2)); ?>" aria-label="Hindi">Hindi</a></li>
                        </ul>
                    </li> -->
    ...
    <nav class="navbar navbar-expand-lg shadow-none sticky-xl-top sticky-lg-top">
        <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
            ...
            <a href="<?php echo e(route('home')); ?>" class="navbar-brand me-auto logo d-flex align-items-center">
                <img src="<?php echo e(asset('admin_assets/images/logo.png')); ?>" alt="logo-icon" class="img-fluid logo" aria-label="Logo of Lal Bahadur Shastri National Academy of Administration">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbar-default">
                <ul class="navbar-nav ms-auto navmenu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('user.get_rti_page', $menu->menu_slug)); ?>" aria-label>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle"
                            href="<?php echo e(route('user.navigationpagesbyslug', $menu->menu_slug)); ?>"
                        ...
                        <!-- <ul class="dropdown-menu">
                            ...
                            <li class="border-bottom">
                                <a class="dropdown-item"
                                    href="<?php echo e(url('lbsnaa-sub')); ?>/<?php echo e($reserch_c->research_centre_slug); ?>">
                    ...
                    <li
                        class="nav-item <?php echo e(renderMenuItems($menu->id, $menu->menutitle === 'Training') ? 'dropdown' : ''); ?>">
                        <?php
                        ...
                        <a class="nav-link <?php echo e(renderMenuItems($menu->id, $menu->menutitle === 'Training') ? 'dropdown-toggle' : ''); ?>"
                            href="<?php echo e($url); ?>" target="<?php echo e($target); ?>">
                            <?php echo e($menu->menutitle); ?>
...
<?php /**PATH /var/www/hardeep/public_html/lbsnaa-website/resources/views/user/includes/header.blade.php ENDPATH**/ ?>