    ...
    <div class="container-fluid bg-light bar">
        <div class="row py-1 align-items-center">
            <div class="col-md-4 d-flex align-items-center" style="font-size: 13px;">
                <img class="img-fluid"
                    src="<?php echo e(asset('admin_assets/images/ashok_logo.png')); ?>"
                ...
                <ul class="nav justify-content-end align-items-center">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <!-- <ul class="dropdown-menu" aria-labelledby="languageDropdown">
                            <li><a class="dropdown-item" href="<?php echo e(route('set.language', 1)); ?>">English</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('set.language', 2)); ?>">Hindi</a></li>
                        </ul> -->
                    </li>
...
</html><?php /**PATH /var/www/hardeep/public_html/lbsnaa-website/resources/views/user/includes/header.blade.php ENDPATH**/ ?>