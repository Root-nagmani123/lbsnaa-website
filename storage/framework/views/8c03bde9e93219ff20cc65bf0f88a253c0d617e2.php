...
<div class="card bg-white border-0 rounded-10 mb-4">
    ...
    <div class="table-responsive">
        <table class="table align-middle" id="myTable">
            ...
            <tbody>
                <?php $__currentLoopData = $coordinators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coordinator): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('coordinators.edit', $coordinator->id)); ?>" class="btn bg-success text-white btn-sm">Edit</a>
                                <form action="<?php echo e(route('coordinators.destroy', $coordinator->id)); ?>" method="POST" style="display:inline;">
                                    <?php echo csrf_field(); ?>
            ...
            data-column="status" data-id="<?php echo e($coordinator->id); ?>" <?php echo e($coordinator->status ? 'checked' : ''); ?>>
          </div></td>
                        </tr>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lbsnaa-website\resources\views/admin/training_master/manage_coordinator/index.blade.php ENDPATH**/ ?>