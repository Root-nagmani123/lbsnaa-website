...
<div class="row justify-content-center">
    <div class="col-lg-12">
        ...
        <?php endif; ?>
                <form action="<?php echo e(route('media-center.update', $audio->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?> <!-- Add this to specify the HTTP method -->
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <select class="form-select form-control ps-5 h-58" name="category_name" id="category_name" required>
                                        ...
                                        <option value="Audio" class="text-dark" <?php echo e($audio->category_name == 'Audio' ? 'selected' : ''); ?>>Audio</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="text" class="form-control text-dark ps-5 h-58" name="audio_title_en"
                                        id="audio_title_en" value="<?php echo e($audio->audio_title_en); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="text" class="form-control text-dark ps-5 h-58" name="audio_title_hi"
                                        id="audio_title_hi" value="<?php echo e($audio->audio_title_hi); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <select class="form-select form-control ps-5 h-58" name="page_status" id="page_status" required>
                                        <option value="1" class="text-dark" <?php echo e($audio->page_status == 1? 'selected' : ''); ?>>Active</option>
                                        <option value="0" class="text-dark" <?php echo e($audio->page_status == 0? 'selected' : ''); ?>>Inactive</option>
                                    </select>
                                </div>
                            </div>
                        </div> 
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lbsnaa-website\resources\views/admin/manage_mediacenter/edit.blade.php ENDPATH**/ ?>