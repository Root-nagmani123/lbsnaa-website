...
<?php endif; ?>
                <form action="<?php echo e(route('media-categories.update', $category->id)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <select class="form-select form-control ps-5 h-58" name="media_gallery" id="media_gallery" required>
                                        ...
                                        <option value="Photo Gallery" class="text-dark" <?php echo e($category->media_gallery == 'Photo Gallery' ? 'selected' : ''); ?>>Photo Gallery</option>
                                        <option value="Video Gallery" class="text-dark" <?php echo e($category->media_gallery == 'Video Gallery' ? 'selected' : ''); ?>>Video Gallery</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <select class="form-select form-control ps-5 h-58" name="status" id="status" required>
                                        ...
                                        <option value="2" class="text-dark" <?php echo e($category->status == '0' ? 'selected' : ''); ?>>Inactive</option>
                                    </select>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lbsnaa-website\resources\views/admin/manage_categories/edit.blade.php ENDPATH**/ ?>