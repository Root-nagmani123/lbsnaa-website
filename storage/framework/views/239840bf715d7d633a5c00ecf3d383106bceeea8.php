    ...
    <div class="col-lg-12">
        <div class="card bg-white border-0 rounded-10 mb-4">
            <div class="card-body p-4">
                ...
                <form action="<?php echo e(route('micromenus.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="radio" name="language" value="1"
                                        <?php echo e(old('language') == 1 ? 'checked' : ''); ?>> English
                                    <input type="radio" name="language" value="2"
                                        <?php echo e(old('language') == 2 ? 'checked' : ''); ?>> Hindi
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <select id="select_research_centre" name="research_centre"
                                    ...
                                    <option value="<?php echo e($id); ?>" <?php echo e(old('research_centre') == $id ? 'selected' : ''); ?>>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="text" class="form-control text-dark  h-58" name="menutitle"
                                        id="menutitle" value="<?php echo e(old('menutitle')); ?>">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <select class="form-select form-control  h-58" aria-label="Default select example"
                                        ...
                                        <!-- <option value="1" class="text-dark" <?php echo e(old('texttype') == '1' ? 'selected' : ''); ?>>Content</option> -->
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="form-group position-relative">
                                                <input type="text" class="form-control text-dark  h-58"
                                                    name="meta_title" id="meta_title" value="<?php echo e(old('meta_title')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="form-group position-relative">
                                            <textarea class="form-control  text-dark" placeholder="Some demo text ... "
                                                ...
                                                value="<?php echo e(old('meta_description')); ?>"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group position-relative">
                                    <select class="form-select form-control  h-58" id="txtpostion" autocomplete="off"
                                        ...
                                        <option value="1" class="text-dark"
                                            <?php echo e(old('txtpostion') == '1' ? 'selected' : ''); ?>>Header Menu</option>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <select class="form-select form-control  h-58" id="menu_status" name="menu_status">
                                        ...
                                        <option value="1" class="text-dark"
                                            <?php echo e(old('menu_status') == '1' ? 'selected' : ''); ?>>Active</option>
                                        <option value="0" class="text-dark"
                                            <?php echo e(old('menu_status') == '0' ? 'selected' : ''); ?>>Inactive</option>
...
$(document).ready(function() {
    $('#select_research_centre').on('change', function() {
        ...
        if (researchCentreId) {
            $.ajax({
                url: "<?php echo e(route('get.menus')); ?>",
                type: "GET",
                data: {
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp11\htdocs\lbsnaa-website\resources\views/admin/micro/manage_micromenus/create.blade.php ENDPATH**/ ?>