                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <select class="form-select form-control ps-5 h-58" name="web_site_target"
                                                ...
                                                <option value="1" <?php echo e($menu->web_site_target == 1 ? 'selected' : ''); ?> class="text-dark">Internal Link</option>
                                                <option value="2" <?php echo e($menu->web_site_target == 2 ? 'selected' : ''); ?> class="text-dark">External Link</option>
                                            </select>
                                            </div>
                                        </div>
                                    </div>
