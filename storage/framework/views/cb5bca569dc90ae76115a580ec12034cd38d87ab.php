...
<body class="d-flex flex-column min-vh-100 bg-white">
        ...
        <nav class="navbar">
            <div class="container-fluid px-0">
                <a class="navbar-brand" href="<?php echo e(route('home')); ?>"><img
                        src="<?php echo e(asset('assets/images/microsites/logo.png')); ?>" alt="logo" width="350"></a>
                <!-- Button -->
                <?php
                ...
                <?php if($centre_name): ?>
                <h2 class="text-dark"><?php echo e($centre_name->research_centre_name); ?><br><span class="text-center"
    ...
    </script><?php /**PATH C:\xampp11\htdocs\lbsnaa-website\resources\views/user/pages/microsites/includes/header.blade.php ENDPATH**/ ?>