    ...
    <div class="col-lg-12">
        <div class="card bg-white border-0 rounded-10 mb-4">
            <div class="card-body p-4">
                ...
                <form action="<?php echo e(route('manage_events.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                        <input class="form-check-input" type="radio" name="page_language" id="page_language" value="English" <?php echo e(old('language') == 'English' ? 'checked' : ''); ?>> English
                                        <input class="form-check-input" type="radio" name="page_language" id="page_language" value="Hindi" <?php echo e(old('language') == 'Hindi' ? 'checked' : ''); ?>> Hindi
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <span class="star">*</span>
                                <div class="form-group position-relative">
                                    <input type="date" class="form-control text-dark ps-5 h-58" name="start_date" id="start_date" value="<?php echo e(old('start_date')); ?>">
                                </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <select class="form-select form-control ps-5 h-58" name="status" id="status" required>
                                        <option value="Draft" class="text-dark" <?php echo e(old('status') == 'Draft' ? 'selected' : ''); ?>>Draft</option>
                                        <option value="Approval" class="text-dark" <?php echo e(old('status') == 'Approval' ? 'selected' : ''); ?>>Approval</option>
                                        <option value="Publish" class="text-dark" <?php echo e(old('status') == 'Publish' ? 'selected' : ''); ?>>Publish</option>
                                    </select>
                                </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lbsnaa-website\resources\views/manage_events/create.blade.php ENDPATH**/ ?>