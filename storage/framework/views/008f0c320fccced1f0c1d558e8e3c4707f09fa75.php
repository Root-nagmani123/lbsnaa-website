                            ...
                            <div class="logo-item">
                                <a href="<?php echo e($footer_icon->link); ?>" target="_blank">
                                    <img src="<?php echo e(asset('footer-images/' . $footer_icon->image)); ?>"
                                        alt="Logo of <?php echo e($footer_icon->title); ?>" title="Logo of <?php echo e($footer_icon->title); ?>"
                                        class="img-fluid"
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-3 col-md-12 col-12 d-lg-flex justify-content-end">
                    <div>
                        ...
                        ?>
                        <!--Facebook-->
                        <a href="<?php echo e($social_media_links[0]->facebook_url); ?>" class="me-2" target="_blank" aria-label="Facebook">
                            <i class="bi bi-facebook fa-2x" style="color: #af2910;"></i>
                        </a>
                        <!--Twitter-->
                        <a href="<?php echo e($social_media_links[0]->twitter_url); ?>" class="me-2" target="_blank" aria-label="Twitter">
                            <i class="bi bi-twitter-x" style="color: #af2910;"></i>
                        </a>

                        <!--GitHub-->
                        <a href="<?php echo e($social_media_links[0]->youtube_url); ?>" class="me-2" target="_blank" aria-label="Youtube">
                            <i class="bi bi-youtube" style="color:#af2910;"></i>
                        </a>
                        <a href="<?php echo e($social_media_links[0]->linkedin_url); ?>" class="me-2" target="_blank" aria-label="Linkedin">
...
</html><?php /**PATH /var/www/hardeep/public_html/lbsnaa-website/resources/views/user/includes/footer.blade.php ENDPATH**/ ?>