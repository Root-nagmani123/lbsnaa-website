...
<head>
    ...
    <title>404 Error | Lal Bahadur Shastri National Academy of Administration</title>
</head>
            ...
            <div class="row">
                <div class="col-xl-10 col-md-12 col-12">
                    <div class="mt-4 d-flex justify-content-between align-items-center">
                        <a href="<?php echo e(route('home')); ?>"><img src="<?php echo e(asset('admin_assets/images/logo.png')); ?>" alt="logo"
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-12 text-center text-lg-start">
                    <div class="d-flex flex-column gap-5">
                        <div class="d-flex flex-column gap-3">
                            <h1 class="display-1 mb-0">Sorry! Error 404 - Page Not Found</h1>

                            <p class="mb-0 lead px-4 px-md-0">
                                The page you are attempting to access cannot be found. It may have been moved / renamed
                                or may no longer exist. We have recently redesigned our website to make it easier and
                                faster for you to find the information you need. This means the bookmarks and addresses
                                you have used in the past may no longer work. To find the information you are looking
                                for please try one of the following.
                            </p>
                            <ul>
                                <li>If you typed the page URL, check the spelling.</li>
                                <li>Go to our <a href="<?php echo e(route('home')); ?>" class="btn-link">Home page</a> and browse
                                    through our topics for the information you want.</li>
                                <li>Go to our <a href="<?php echo e(url()->previous()); ?>" class="btn-link">previous page</a> and browse through our topics for the information you want.
                                </li>
                            </ul>
                        </div>
                    </div>
...
</html><?php /**PATH C:\xampp1\htdocs\lbsnaa-website\resources\views/errors/404.blade.php ENDPATH**/ ?>