                ...
                <table class="table align-middle" id="myTable">
                    ...
                    <tbody>
                        ...
                        <tr style="overflow-x: scroll">
                            ...
                            <td><?php echo e($faculty->category == 1 ? 'Inhouse' : 'Visiting'); ?></td>
                            <td>
                            ...
                            <td>
                                <div class="form-check form-switch">
                                    <input class="form-check-input status-toggle" type="checkbox" role="switch"
                                        ...
                                        data-id="<?php echo e($faculty->id); ?>" <?php echo e($faculty->page_status ? 'checked' : ''); ?>>
                                </div>
                            </td>
                        </tr>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp11\htdocs\lbsnaa-website\resources\views/admin/faculty_members/index.blade.php ENDPATH**/ ?>