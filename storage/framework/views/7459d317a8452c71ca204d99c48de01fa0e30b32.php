                                ...
                                <div class="row" id="content-field" style="display: none;">
                                    <div class="col-lg-12">
                                        <div class="form-group mb-0">
                                            ...
                                            <span class="star">*</span>
                                            <div class="form-group position-relative">
                                                <textarea class="form-control ps-5 text-dark" rows="5" name="content" id="content"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-4">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lbsnaa-website\resources\views/admin/micro/manage_micromenus/create.blade.php ENDPATH**/ ?>