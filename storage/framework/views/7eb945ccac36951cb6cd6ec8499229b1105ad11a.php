                            ...
                            <?php $__currentLoopData = $Research_Center_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reserch_c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="border-bottom">
                                    <?php if($reserch_c->pdf): ?>
                                        <!-- Redirect to PDF -->
                                        <a class="dropdown-item" href="<?php echo e(asset('storage/' . $reserch_c->pdf)); ?>" target="_blank">
                                            <?php echo e($reserch_c->research_centre_name); ?>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <a class="dropdown-item" href="<?php echo e(url('lbsnaa-sub/' . $reserch_c->research_centre_slug)); ?>">
                                            <?php echo e($reserch_c->research_centre_name); ?>
...
</html><?php /**PATH C:\xampp11\htdocs\lbsnaa-website\resources\views/user/includes/header.blade.php ENDPATH**/ ?>