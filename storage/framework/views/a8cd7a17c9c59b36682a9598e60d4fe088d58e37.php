                ...
                <form action="<?php echo e(route('admin.section_category.store')); ?>" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="d-flex ms-sm-3 ms-md-0">
                            ...
                            <a href="<?php echo e(route('admin.section_category', ['catid' => $id])); ?>" class="btn btn-secondary text-white">Back</a>
                        </div>
                    </div>
                </form>
            </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp11\htdocs\lbsnaa-website\resources\views/admin/sections/section_category/create.blade.php ENDPATH**/ ?>