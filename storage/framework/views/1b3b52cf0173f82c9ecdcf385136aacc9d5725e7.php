    ...
    <div class="col-lg-12">
        <div class="card bg-white border-0 rounded-10 mb-4">
            <div class="card-body p-4">
                ...
                <form action="<?php echo e(route('subcategory.update', $subcategory->id)); ?>" method="POST"
                    ...
                    <div class="row">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="radio" name="language" value="1"
                                        <?php echo e($subcategory->language == '1' ? 'checked' : ''); ?>> English
                                    <input type="radio" name="language" value="2"
                                        <?php echo e($subcategory->language == '2' ? 'checked' : ''); ?>> Hindi
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="text" class="form-control text-dark ps-5 h-58" name="category_name"
                                        id="category_name" value="<?php echo e($subcategory->category_name); ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="color" class="form-control text-dark ps-5 h-58" name="color_theme"
                                            id="color_theme" value="<?php echo e(old('color_theme', $subcategory->color_theme)); ?>"
                                            required>
                                    </div>
                                    <div class="col-6">
                                        <!-- Hex Code Display -->
                                        <p id="selected-color" class="label">
                                            ...
                                            <input type="text" class="text-muted form-control mt-2" id="color_hex"
                                                name="color_theme"
                                                value="<?php echo e(old('color_theme', $subcategory->color_theme)); ?>">
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <select class="form-select form-control ps-5 h-58" name="parent_id" id="parent_id"
                                        ...
                                        <option value="<?php echo e($category->id); ?>" class="text-dark"
                                            <?php echo e($subcategory->parent_id == $category->id ? 'selected' : ''); ?>>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <textarea name="description" id="description" rows="3" required
                                        class="form-control text-dark"><?php echo e($subcategory->description); ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                                ...
                                <div class="form-group position-relative">
                                    <select class="form-select form-control ps-5 h-58" name="status" id="status"
                                        ...
                                        <option value="1" class="text-dark"
                                            <?php echo e($subcategory->status == '1' ? 'selected' : ''); ?>>Active</option>
                                        <option value="2" class="text-dark"
                                            <?php echo e($subcategory->status == '0' ? 'selected' : ''); ?>>Inactive</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex ms-sm-3 ms-md-0">
                            ...
                            <a href="<?php echo e(route('subcategory.index')); ?>" class="btn btn-secondary text-white">Back</a>
                        </div>
                    </div>
                </form>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp6\htdocs\lbsnaa_website\resources\views/admin/manage_coursesubcategories/edit.blade.php ENDPATH**/ ?>