    ...
    <div class="col-lg-12">
        <div class="card bg-white border-0 rounded-10 mb-4">
            <div class="card-body p-4">
                ...
                <form action="<?php echo e(route('photo-gallery.update', $gallery->id)); ?>" method="POST"
                    ...
                    <div class="row">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <select name="image_relate_with_news" id="image_relate_with_news"
                                        ...
                                        <option value="News"
                                            <?php echo e((old('image_relate_with_news', $gallery->image_relate_with_news) == 'News') ? 'selected' : ''); ?>>
                                            News</option>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group position-relative">
                                    <select name="image_relate_with_training" id="image_relate_with_training"
                                        ...
                                        <option value="Training Programme"
                                            <?php echo e((old('image_relate_with_training', $gallery->image_relate_with_training) == 'Training Programme') ? 'selected' : ''); ?>>
                                ...
                                <div class="form-grroup position-relative">
                                    <select name="image_relate_with_events" id="image_relate_with_events"
                                        ...
                                        <option value="Related Events"
                                            <?php echo e((old('image_relate_with_events', $gallery->image_relate_with_events) == 'Related Events') ? 'selected' : ''); ?>>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <select name="status" required class="form-control text-dark ps-5 h-58">
                                        <option value="1"
                                            <?php echo e((old('status', $gallery->status) == '1') ? 'selected' : ''); ?>>
                                            Active</option>
                                        <option value="2"
                                            <?php echo e((old('status', $gallery->status) == '0') ? 'selected' : ''); ?>>
                                            Inactive</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="d-flex ms-sm-3 ms-md-0 mt-4">
                            ...
                            <a href="<?php echo e(route('photo-gallery.index')); ?>" class="btn btn-secondary text-white">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lbsnaa-website\resources\views/admin/manage_photo/edit.blade.php ENDPATH**/ ?>