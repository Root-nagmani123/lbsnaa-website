                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><a href="<?php echo e(route('organisation_chart.sub_org', ['parent_id' => $record->id])); ?>" class="btn btn-secondary btn-sm text-white">click here</a></td>
                                <td><?php echo e($employeeNames); ?></td>
                                <td><?php echo e($record->description); ?></td>                              
                                <td>
                                    <a href="<?php echo e(route('organisation_chart.edit', $record->id)); ?>" class="btn bg-success text-white btn-sm">Edit</a>
                                    <form action="<?php echo e(route('organisation_chart.destroy', $record->id)); ?>" method="POST" style="display:inline;">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp11\htdocs\lbsnaa-website\resources\views/admin/manage_organisationchart/sub_org.blade.php ENDPATH**/ ?>