                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <?php $__currentLoopData = $breadcrumb; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $crumb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(!$loop->last): ?>
                                    <li class="breadcrumb-item">
                                        <a href="<?php echo e(route('user.navigationmenubyslug', $crumb['slug'])); ?>?slug=<?php echo e(request()->query('slug') ?: $crumb['slug']); ?>" style="color: #af2910;"><?php echo e($crumb['title']); ?></a>
                                    </li>
                                <?php else: ?>
...
<?php /**PATH /var/www/hardeep/public_html/lbsnaa-website/resources/views/user/pages/microsites/navigationmenubyslug.blade.php ENDPATH**/ ?>