                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="radio" name="language" value="1"
                                        <?php echo e($socialMedia->language == '1' ? 'checked' : ''); ?>> English
                                    <input type="radio" name="language" value="2"
                                        <?php echo e($socialMedia->language == '2' ? 'checked' : ''); ?>> Hindi
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="text" class="form-control text-dark ps-5 h-58" name="txtename"
                                        id="txtename" disabled value="<?php echo e($socialMedia->title ?? ''); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="text" class="form-control text-dark ps-5 h-58" name="facebook"
                                        id="facebook" value="<?php echo e($socialMedia->facebook_url ?? ''); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="text" class="form-control text-dark ps-5 h-58" name="twitter"
                                        id="twitter" value="<?php echo e($socialMedia->twitter_url ?? ''); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="text" class="form-control text-dark ps-5 h-58" name="googleplus"
                                        id="googleplus" value="<?php echo e($socialMedia->youtube_url ?? ''); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="text" class="form-control text-dark ps-5 h-58" name="linkedin"
                                        id="linkedin" value="<?php echo e($socialMedia->linkedin_url ?? ''); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                                ...
                                <div class="form-group position-relative">
                                    <select class="form-select form-control ps-5 h-58" name="txtstatus" id="txtstatus"
                                        ...
                                        <option value="1" class="text-dark"
                                            <?php echo e(isset($socialMedia) && $socialMedia->status == 1 ? 'selected' : ''); ?>>
                                            Active</option>
                                        <option value="0" class="text-dark"
                                            <?php echo e(isset($socialMedia) && $socialMedia->status == 0 ? 'selected' : ''); ?>>
                                            Inactive</option>
                                    </select>
                                </div>
                            </div>
