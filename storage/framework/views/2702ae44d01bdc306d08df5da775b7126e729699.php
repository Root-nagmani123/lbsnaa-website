...
<div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
    ...
    <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
        ...
        <li>
            <span class="fw-semibold fs-14 heading-font text-dark dot ms-2">New Slider</span>
        </li>
    </ul>
</div>
                ...
                <form action="<?php echo e(route('admin.slider_store')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="d-flex ms-sm-3 ms-md-0">
                            ...
                            <a href="<?php echo e(route('admin.slider_list')); ?>" class="btn btn-secondary text-white">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lbsnaa-website\resources\views/admin/home/slider_create.blade.php ENDPATH**/ ?>