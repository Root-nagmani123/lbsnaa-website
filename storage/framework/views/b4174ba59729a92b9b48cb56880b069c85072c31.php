...
<div id="carouselExampleCaptions" class="carousel slide position-relative carousel-fade" data-bs-ride="carousel"
    ...
    <div class="carousel-inner">
        <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="carousel-item <?php echo e($key == 0 ? 'active' : ''); ?>">
                <img src="<?php echo e(asset('slider-images/' . $slider->image)); ?>" class="d-block w-100"
                    alt="<?php echo e($slider->description); ?>">
                <div class="carousel-caption">
                    <p class="text-center slider-caption"><?php echo e($slider->text); ?></p>
                </div>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
    ...
    <button id="playPauseBtn" class="btn btn-primary btn-sm"
        aria-label="
    <?php echo e($_COOKIE['language'] == '2' ? 'स्लाइडर के लिए प्ले / पॉज़ बटन' : 'Play/Pause button for Sliders'); ?>">
        <i class="bi bi-pause-fill"></i>
        <?php echo e($_COOKIE['language'] == '2' ? 'रोकें' : 'Pause'); ?>
                ...
                <div id="marqueeContainer" class="d-flex gap-3 flex-nowrap align-items-center">
                    <?php $__currentLoopData = $news_scrollers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scroller): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(!empty($scroller->website_url)): ?>
                            <a href="<?php echo e(str_starts_with($scroller->website_url, 'http') ? $scroller->website_url : 'http://' . $scroller->website_url); ?>"
                                target="_blank"
        ...
        <div class="row gy-4 gy-xl-0">
            <div class="col-md-2 col-12 mb-4">
                <div class="card card-lift text-center text-lg-start h-100">
                    ...
                    <div class="card-body pt-2" style=" height: 80px;">
                        <a href="<?php echo e(url($_COOKIE['language'] == '2' ? 'menu/director-message_hi' : 'menu/director-message')); ?>"
                            class="icon-link icon-link-hover link-primary">
                            <?php echo e($_COOKIE['language'] == '2' ? 'संदेश' : 'Message'); ?>

                        </a>
                        <br>
                        <a href="<?php echo e(url($_COOKIE['language'] == '2' ? 'menu/previous-directors_hi' : 'menu/previous-directors')); ?>"
                            class="icon-link icon-link-hover link-primary">
                            <?php echo e($_COOKIE['language'] == '2' ? 'पूर्व निदेशक' : 'Previous Director'); ?>
                            ...
                            <ul>
                                ...
                                <?php $__currentLoopData = $current_course; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        ...
                                        <?php if(isset($_COOKIE['language']) && $_COOKIE['language'] == '2'): ?>
                                            <?php \Carbon\Carbon::setLocale('hi'); ?>
                                            पाठ्यक्रम समन्वयक: <?php echo e($course->coordinator_id); ?><br>
                                            <?php echo e(\Carbon\Carbon::parse($course->course_start_date)->translatedFormat('d F, Y')); ?>

                                            से
                                            <?php echo e(\Carbon\Carbon::parse($course->course_end_date)->translatedFormat('d F, Y')); ?>

                                            तक
                                        <?php else: ?>
                                            Course Coordinator: <?php echo e($course->coordinator_id); ?><br>
                                            <?php echo e(\Carbon\Carbon::parse($course->course_start_date)->format('d F, Y')); ?>

                                            to
                                            <?php echo e(\Carbon\Carbon::parse($course->course_end_date)->format('d F, Y')); ?>
                ...
                <div class="card card-lift text-center text-lg-start h-100">
                    ...
                    <div class="card-footer" style="border:none;float: right;text-align: right;">
                        <button class="btn btn-primary btn-sm"><a href="<?php echo e(route('user.upcomingCourses')); ?>"
                                style="color: white;" aria-label="View All Upcoming Courses">
                                <?php if($_COOKIE['language'] == '2'): ?>
                                    सभी को देखें
                                <?php else: ?>
                                    View All
            ...
            <div class="col-md-2 col-12 mb-4">
                <div class="card card-lift text-center text-lg-start h-100">
                    ...
                    <div class="card-header" style="border-bottom: none;">
                        <p class="fw-bold">
                            <?php echo e($_COOKIE['language'] == '2' ? 'अकादमी में जीवन' : 'Life at Academy'); ?>

                        </p>
                    </div>
                    <div class="card-body pt-2" style="height: 80px;">
                        <a href="<?php echo e(url($_COOKIE['language'] == '2' ? 'menu/the-academy-experience_hi' : 'menu/the-academy-experience')); ?>"
                            class="icon-link icon-link-hover link-primary">
                            <?php echo e($_COOKIE['language'] == '2' ? 'अकादमी का अनुभव' : 'The Academy Experience'); ?>

                        </a><br>

                        <a href="<?php echo e(url($_COOKIE['language'] == '2' ? 'menu/a-day-in-the-life-of-a-trainee_hi' : 'menu/a-day-in-the-life-of-a-trainee')); ?>"
                            class="icon-link icon-link-hover link-primary">
                            <?php echo e($_COOKIE['language'] == '2' ? 'एक प्रशिक्षु के जीवन का एक दिन' : 'A day in the life of a Trainee'); ?>
            ...
            <div class="col-md-2 col-12 mb-4">
                <div class="card card-lift text-center text-lg-start h-100">
                    ...
                    <div class="card-body pt-2" style="height: 80px;">
                        <a href="<?php echo e(url('souvenir?pro_category=7')); ?>"
                            class="icon-link icon-link-hover link-primary">
                            <?php if($_COOKIE['language'] == '2'): ?>
                                यादगार लम्हे
                            <?php else: ?>
                        ...
                        <a href="<?php echo e(url('souvenir?pro_category=6')); ?>"
                            class="icon-link icon-link-hover link-primary">
                            <?php if($_COOKIE['language'] == '2'): ?>
                                परिधान
                            <?php else: ?>
                        ...
                        <div class="card-header" style="background-color:#af2910">
                            <h2 class="text-white h4">
                                ...
                                <?php else: ?>
                                    LBSNAA Academy News
                                <?php endif; ?>
                                <span class="float-end"><a href="<?php echo e(route('user.news_listing')); ?>"
                                        class="text-white" style="text-decoration: none;font-size:14px"
                                        aria-label="View All Academy News">
                                        <?php if($_COOKIE['language'] == '2'): ?>
                                            सभी को देखें
                                        <?php else: ?>
                                            View All
                                            ...
                                            <div class="card">
                                                <div class="card-header p-0 border-0">
                                                    <img src="<?php echo e(isset($slider->main_image) && !empty($slider->main_image) ? asset($slider->main_image) : asset('assets/images/4.jpg')); ?>"
                                                        ...
                                                        alt="<?php echo e($slider->short_description); ?>"
                                                        aria-label="<?php echo e($slider->short_description); ?>"
                                                        style="object-fit: cover; height: 250px; width: 100%;">
                                                </div>
                                                <div class="card-body" style="height: 200px; overflow-y: hidden;">
                                                    <span class="fs-5 mb-2 fw-semibold d-block"
                                                        style="color:#007A33;">
                                                        <?php if(isset($_COOKIE['language']) && $_COOKIE['language'] == '2'): ?>
                                                            प्रकाशित किया गया:
                                                        <?php else: ?>
                                                            Posted On:
                                                        <?php endif; ?>
                                                        <?php echo e(\Carbon\Carbon::parse($slider->start_date)->format('d F, Y')); ?>
                                                    ...
                                                    <h3>
                                                        ...
                                                        <a href="<?php echo e(route('user.newsbyslug', $slider->title_slug)); ?>"
                                                            ...
                                                            <?php echo e(($_COOKIE['language'] ?? '1') == '2' ? $slider->title_hindi ?? $slider->title : $slider->title); ?>
                                                    ...
                                                    <?php
                                                        $lang = $_COOKIE['language'] ?? '1';
                                                        $description =
                                                            $lang == '2' && !empty($slider->description_hindi)
                                                                ? $slider->description_hindi
                                                ...
                                                <div class="card-footer border-0" style="height:50px;">
                                                    <a href="<?php echo e(route('user.newsbyslug', $slider->title_slug)); ?>"
                                                        ...
                                                        aria-label="Read More <?php echo e($slider->short_description); ?>">
                                                        <span>
                                                            <?php if($_COOKIE['language'] == '2'): ?>
                                                                और पढ़ें
                                                            <?php else: ?>
                            ...
                            <?php $__currentLoopData = $quick_links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $quick_link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="text-start list-group-item">
                                    <?php if(!empty($quick_link->url)): ?>
                                        ...
                                        <a href="<?php echo e(route('advisory', ['filename' => $quick_link->file])); ?>" target="_blank" class="text-decoration-none text-primary">
                                                <span>
...
<?php echo $__env->make('user.includes.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\lbsnaa-website\resources\views/user/pages/home.blade.php ENDPATH**/ ?>