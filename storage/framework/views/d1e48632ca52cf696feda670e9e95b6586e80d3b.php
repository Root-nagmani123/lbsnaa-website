...
<div class="card bg-white border-0 rounded-10 mb-4">
    ...
    <?php endif; ?>
        <div class="default-table-area members-list recent-orders">
                ...
                <table class="table align-middle" id="myTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo e(route('admin.section_category.index', ['catid' => $section->id])); ?>" class="">Click Here</a></td>
                            <td>
            ...
            data-column="status" data-id="<?php echo e($section->id); ?>" <?php echo e($section->status ? 'checked' : ''); ?>>
          </div></td>
                        </tr>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp6\htdocs\lbsnaa_website\resources\views/admin/sections/index.blade.php ENDPATH**/ ?>