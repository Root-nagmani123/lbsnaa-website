                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('home')); ?>" class="text-primary">
                        ...
                        <li class="breadcrumb-item">
                            <a
                                href="<?php echo e(route('user.navigationpagesbyslug', $crumb['slug'])); ?>" class="text-primary"><?php echo e($crumb['title']); ?></a>
                        </li>
                        <?php else: ?>
