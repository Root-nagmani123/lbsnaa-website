                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <!-- <td>
                                ...
                                <?php if(in_array(pathinfo($vacancy->document_upload, PATHINFO_EXTENSION), ['jpg', 'png',
                                'jpeg'])): ?>
                            ...
                            <td>
                                <div class="d-flex flex-column flex-sm-row gap-2">
                                    <a href="<?php echo e(route('micro_manage_vacancy.edit', $vacancy->id)); ?>"
                                    ...
                                    <form action="<?php echo e(route('micro_manage_vacancy.destroy', $vacancy->id)); ?>"
                            ...
                            <td>
                                <div class="form-check form-switch">
                                    <input class="form-check-input status-toggle" type="checkbox" role="switch"
                                        ...
                                        data-id="<?php echo e($vacancy->id); ?>" <?php echo e($vacancy->status ? 'checked' : ''); ?>>
                                </div>
                            </td>
                        </tr>
