...
<div class="card bg-white border-0 rounded-10 mb-4">
    ...
    <?php endif; ?>
        <div class="default-table-area members-list recent-orders">
            ...
            data-column="page_status" data-id="<?php echo e($staff->id); ?>" <?php echo e($staff->page_status ? 'checked' : ''); ?>>
          </div></td>
                        </tr>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lbsnaa-website\resources\views/admin/staff_members/index.blade.php ENDPATH**/ ?>