    ...
    $(document).ready(function() {
        ...
        $('.status-toggle').change(function() {
            ...
            $.ajax({
                ...
                url: '<?php echo e(url("admin/menus")); ?>/' + menuId + '/toggle-status',
                type: 'POST',
                data: {
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp11\htdocs\lbsnaa-website\resources\views/admin/menus/index.blade.php ENDPATH**/ ?>