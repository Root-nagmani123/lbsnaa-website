...
<div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
    ...
    <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
        ...
        <li>
            <span class="fw-semibold fs-14 heading-font text-dark dot ms-2">Manage Sections Category</span>
        </li>
    </ul>
</div>
<div class="card bg-white border-0 rounded-10 mb-4">
    <div class="card-body p-4">
        <div class="d-sm-flex text-center justify-content-between align-items-center border-bottom pb-20 mb-20">
            <h4 class="fw-semibold fs-18 mb-sm-0">Manage Sections Category</h4>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lbsnaa-website\resources\views/admin/sections/section_category/index.blade.php ENDPATH**/ ?>