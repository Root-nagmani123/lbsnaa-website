...
<div class="card bg-white border-0 rounded-10 mb-4">
    <div class="card-body p-4">
        <div class="d-sm-flex text-center justify-content-between align-items-center border-bottom pb-20 mb-20">
            ...
            <a href="<?php echo e(route('photo-gallery.create')); ?>">
                ...
                <table class="table align-middle" id="myTable">
                    ...
                    <tbody>
                        ...
                        <td><?php echo e($loop->iteration); ?></td> <!-- Auto-incrementing index -->
                            ...
                            <td>
                                <a href="<?php echo e(route('photo-gallery.edit', $gallery->id)); ?>" class="btn bg-success text-white btn-sm">Edit</a>
                                <form action="<?php echo e(route('photo-gallery.destroy', $gallery->id)); ?>" method="POST" style="display:inline;">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp5\htdocs\lbsnaa_website\resources\views/admin/manage_photo/index.blade.php ENDPATH**/ ?>