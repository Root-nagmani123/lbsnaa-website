    ...
    <div class="col-lg-12">
        <div class="card bg-white border-0 rounded-10 mb-4">
            ...
            <div class="d-flex justify-content-between align-items-center border-bottom pb-20 mb-20">
                ...
                <form action="<?php echo e(route('manage_tender.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="d-flex ms-sm-3 ms-md-0">
                        ...
                        <a href="<?php echo e(route('manage_tender.index')); ?>" class="btn btn-primary text-white fw-semibold">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp11\htdocs\lbsnaa-website\resources\views/admin/manage_tender/create.blade.php ENDPATH**/ ?>