                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="<?php echo e(route('user.micrositebyslug')); ?>" style="color: #af2910;">Home</a>
                            </li>
                            <!-- Dynamic breadcrumbs -->
                            <?php $__currentLoopData = $breadcrumb; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $crumb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(!$loop->last): ?>
                                    <li class="breadcrumb-item">
                                        <a href="<?php echo e(route('user.navigationmenubyslug', $crumb['slug'])); ?>"><?php echo e($crumb['title']); ?></a>
                                    </li>
                                <?php else: ?>
...
<?php /**PATH C:\xampp\htdocs\lbsnaa-website\resources\views/user/pages/microsites/navigationmenubyslug.blade.php ENDPATH**/ ?>