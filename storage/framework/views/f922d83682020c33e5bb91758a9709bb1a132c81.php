                                ...
                                <div class="form-group position-relative">
                                    <select class="form-select form-control ps-5 h-58" name="status" id="status"
                                        ...
                                        <option value="1" class="text-dark"
                                            <?php echo e($coordinator->status === '1' ? 'selected' : ''); ?>>Active</option>
                                        <option value="0" class="text-dark"
                                            <?php echo e($coordinator->status === '0' ? 'selected' : ''); ?>>Inactive</option>
                                    </select>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lbsnaa-website\resources\views/admin/training_master/manage_coordinator/edit.blade.php ENDPATH**/ ?>