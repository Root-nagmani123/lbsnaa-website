        ...
        <table class="table align-middle" id="myTable">
            ...
            <tbody>
                ...
                <td><?php echo e($loop->iteration); ?></td>
                    ...
                    <td>
                        <a href="<?php echo e(route('country.edit', $cat->id)); ?>" class="btn btn-success text-white btn-sm">Edit</a>
                        <form action="<?php echo e(route('country.destroy', $cat->id)); ?>" method="POST" style="display:inline;">
                            <?php echo csrf_field(); ?>
