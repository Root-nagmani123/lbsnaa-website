...
<div class="card bg-white border-0 rounded-10 mb-4">
    <div class="card-body p-4">
        <div class="d-sm-flex text-center justify-content-between align-items-center border-bottom pb-20 mb-20">
            ...
            <a href="<?php echo e(route('Managenews.create')); ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-start align-items-start gap-2">
                                    <a href="<?php echo e(route('Managenews.edit', $item->id)); ?>"
                                        class="btn btn-success text-white btn-sm">
                                        Edit
                                    </a>
                                    <form action="<?php echo e(route('Managenews.destroy', $item->id)); ?>" method="POST"
                                        class="m-0">
                                        <?php echo csrf_field(); ?>
                            ...
                            <td>
                                <div class="form-check form-switch">
                                    <input class="form-check-input status-toggle" type="checkbox" role="switch"
                                        data-table="managenews" data-column="status" data-id="<?php echo e($item->id); ?>"
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lbsnaa-website\resources\views/admin/micro/managenews/index.blade.php ENDPATH**/ ?>