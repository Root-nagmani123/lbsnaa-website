    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-9 mb-4">
                ...
                <h2 class="text-center uppercase" style="color:#af2910"><?php echo e(($research_centre->home_title)); ?> <br><span><img
                            src="<?php echo e(asset('assets/images/devider.png')); ?>" alt="<?php echo e($research_centre->home_title); ?>"></span></h2>
                ...
                <div class="d-flex flex-wrap gap-3">
                    ...
                    <a href="<?php echo e(route('mediagallery', ['slug' => $research_centre->research_centre_slug])); ?>"
                        ...
                        <div class="card-body">
                            <img src="<?php echo e(asset('assets/images/image (2).png')); ?>" alt="<?php echo e($research_centre->home_title); ?>" class="img-fluid">
                    ...
                    <a href="<?php echo e(route('news', ['slug' => $research_centre->research_centre_slug])); ?>"
                        class="card border shadow-sm text-center" style="width: 200px;">
                        <div class="card-body">
                            <img src="<?php echo e(asset('assets/images/newspaper (1).png')); ?>" alt="<?php echo e($research_centre->home_title); ?>" class="img-fluid">
