            ...
            <div class="offset-xl-1 col-xl-10 col-md-12 col-12">
                ...
                <div class="row">
                    ...
                    <div class="col d-flex justify-content-center align-items-center">
                        <div class="mb-3 mt-3">
                            <a href="<?php echo e($footer_icon->link); ?>" target="_blank"><img src="<?php echo e(asset('footer-images/' . $footer_icon->image)); ?>" alt="<?php echo e($footer_icon->title); ?>" title="<?php echo e($footer_icon->title); ?>" class="img-fluid"
            ...
            <div class="row justify-content-center text-center align-items-center">
                <div class="col-12 col-md-12 px-0">
                    <nav class="nav nav-footer justify-content-center">
                        ...
                        <a class="nav-link"
                            href="<?php echo e(str_starts_with($footer_link->website_url, 'http') ? $footer_link->website_url : 'http://' . $footer_link->website_url); ?>"
                            target="_blank">
