                ...
                <form action="<?php echo e(route('admin.faculty.store')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="d-flex ms-sm-3 ms-md-0">
                            ...
                            <a href="<?php echo e(route('admin.faculty.index')); ?>" class="btn btn-secondary text-white fw-semibold">Back</a>
                        </div>
                    </div>
                </form>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lbsnaa-website\resources\views/admin/faculty_members/create.blade.php ENDPATH**/ ?>