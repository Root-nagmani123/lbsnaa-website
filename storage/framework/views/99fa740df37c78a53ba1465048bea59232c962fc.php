...
<head>
    ...
    <script src="<?php echo e(asset('assets/js/orgchart.js')); ?>"></script>
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <title>
        <?php if(isset($title)): ?>
            <?php echo e($title); ?> | 
            <?php echo e((isset($_COOKIE['language']) && $_COOKIE['language'] == '2') 
...
<body class="d-flex flex-column min-vh-100 bg-white" style="overflow-x: hidden">
    <div class="container-fluid bg-light bar">
        <div class="row py-1 align-items-center">
            <div class="col-md-6 d-flex align-items-center" style="font-size: 16px;font-weight:400;color:#af2910;">
                <img class="img-fluid" src="<?php echo e(asset('assets/images/icons/ashok.jpg')); ?>" alt="Logo of Ashok Stambh"
                ...
                <ul class="nav justify-content-end align-items-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link fw-bold" href="#skip_to_main_content" data-bs-toggle="tooltip"
                            data-bs-placement="bottom"title="<?php if($_COOKIE['language'] == '2'): ?>मुख्य सामग्री पर जाएं <?php else: ?> Skip to main content <?php endif; ?>"
                            aria-label="<?php if($_COOKIE['language'] == '2'): ?>मुख्य सामग्री पर जाएं <?php else: ?> Skip to main content <?php endif; ?>">
                            <img src="<?php echo e(asset('assets/images/skip_to_main_content.png')); ?>" alt="skip to main content"
                                style="height: 30px;">
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('user.screen-reader')); ?>" data-bs-toggle="tooltip"
                            data-bs-placement="bottom" title="<?php if($_COOKIE['language'] == '2'): ?>स्क्रीन रीडर <?php else: ?> Screen Reader <?php endif; ?>"
                            aria-label="<?php if($_COOKIE['language'] == '2'): ?>स्क्रीन रीडर <?php else: ?> Screen Reader <?php endif; ?>">
                            <img src="<?php echo e(asset('assets/images/screenreadeer.png')); ?>" alt="screen reader"
                                style="height: 30px;">
                        </a>
                    </li>
                    ...
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                        aria-expanded="false"
                        title="<?php if($_COOKIE['language'] == '2'): ?>सुलभता <?php else: ?> Accessibility <?php endif; ?>"
                        aria-label="<?php if($_COOKIE['language'] == '2'): ?>विस्तारित सुलभता मेनू <?php else: ?> Expanded accessibility menu <?php endif; ?>">
                        <img src="<?php echo e(asset('assets/images/Accessibility (2).png')); ?>" 
                            alt="<?php if($_COOKIE['language'] == '2'): ?>सुलभता <?php else: ?> Accessibility <?php endif; ?>"
                            style="height: 30px;">
                    </a>
                    ...
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                            ...
                            title="<?php if($_COOKIE['language'] == '2'): ?>सोशल मीडिया लिंक <?php else: ?> Social Media Links <?php endif; ?>"
                            aria-label="<?php if($_COOKIE['language'] == '2'): ?>विस्तारित सोशल मीडिया लिंक <?php else: ?> Expanded Social Media Links <?php endif; ?>">
                            <img src="<?php echo e(asset('assets/images/social_group.png')); ?>" 
                                alt="<?php if($_COOKIE['language'] == '2'): ?>सोशल मीडिया लिंक <?php else: ?> Social Media Links <?php endif; ?>"
                                style="height: 30px;">
                        </a>
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="<?php echo e($social_media_links[0]->facebook_url); ?>" class="dropdown-item"
                                    target="_blank" title="Facebook" aria-label="Facebook">
                                    <i class="bi bi-facebook fa-2x" style="color: #af2910;"></i>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo e($social_media_links[0]->twitter_url); ?>" class="dropdown-item"
                                    target="_blank" title="Twitter" aria-label="Twitter">
                                    <i class="bi bi-twitter-x" style="color: #af2910;"></i>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo e($social_media_links[0]->youtube_url); ?>" class="dropdown-item"
                                    target="_blank" title="YouTube" aria-label="YouTube">
                                    <i class="bi bi-youtube" style="color:#af2910;"></i>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo e($social_media_links[0]->linkedin_url); ?>" class="dropdown-item"
                    ...
                    <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('user.sitemap')); ?>" data-bs-toggle="tooltip"
                        data-bs-placement="bottom"
                        title="<?php if($_COOKIE['language'] == '2'): ?>साइटमैप <?php else: ?> Sitemap <?php endif; ?>"
                        aria-label="<?php if($_COOKIE['language'] == '2'): ?>साइटमैप <?php else: ?> Sitemap <?php endif; ?>">
                        <img src="<?php echo e(asset('assets/images/sitemap.png')); ?>" 
                            alt="<?php if($_COOKIE['language'] == '2'): ?>साइटमैप <?php else: ?> Sitemap <?php endif; ?>"
                            style="height: 30px;">
                    </a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="#" data-bs-toggle="dropdown" aria-expanded="false"
                            ...
                            <img src="<?php echo e(asset('assets/images/search.png')); ?>" alt="search" style="height: 30px;">
                        </a>
                        <div class="dropdown-menu p-2 custom-dropdown" style="width: 250px;">
                        <form action="https://www.google.com/search" method="GET" target="_blank">
                        <input type="text" name="q" class="form-control mb-2" 
                            placeholder="<?php echo e($_COOKIE['language'] == '2' ? 'खोजें...' : 'Search...'); ?>" required>
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="searchWeb">
                                <?php echo e($_COOKIE['language'] == '2' ? 'वेब' : 'The Web'); ?>

                            </label>
                        </div>

                        <button type="submit" class="btn btn-primary btn-sm w-100 mt-2">
                            <?php echo e($_COOKIE['language'] == '2' ? 'खोजें' : 'Search'); ?>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle fw-bold" href="#" id="languageDropdown" role="button"
                            ...
                            <img src="<?php echo e(asset('assets/images/language.png')); ?>" alt="language" style="height: 30px;">
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="languageDropdown">
                            <li><a class="dropdown-item set-language" data-lang="1" href="<?php echo e(route('set.language', 1)); ?>" aria-label="English">English</a></li>
                            <li><a class="dropdown-item set-language" data-lang="2" href="<?php echo e(route('set.language', 2)); ?>" aria-label="Hindi">Hindi</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
    ...
    <nav class="navbar navbar-expand-lg shadow-none">
        <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
            <!-- Logo -->
            <h1><a href="<?php echo e(route('home')); ?>" class="navbar-brand me-auto logo d-flex align-items-center">
                    <img src="<?php echo e(asset('admin_assets/images/logo.png')); ?>" alt="logo-icon" class="img-fluid logo"
            ...
            <div class="collapse navbar-collapse" id="navbar-default">
                <ul class="navbar-nav ms-auto navmenu">
                    ...
                    <?php if($menu->menutitle === 'RTI' || $menu->menu_slug === 'rti_hi'): ?>
                    <li class="nav-item">
                    ...
                    <?php elseif($menu->menutitle === 'Research Centers' || $menu->menu_slug === 'research-centers_hi'): ?>

                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle"
                            href="<?php echo e(route('user.navigationpagesbyslug', $menu->menu_slug)); ?>" data-bs-toggle="dropdown"
                            aria-expanded="false" aria-label="Expanded <?php echo e($menu->menutitle); ?>">
                            <?php echo e($menu->menutitle); ?>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="border-bottom">
                                <?php if($reserch_c->pdf): ?>
                                <!-- Redirect to PDF -->
                                <a class="dropdown-item" href="<?php echo e(asset('storage/' . $reserch_c->pdf)); ?>"
                                    target="_blank" aria-expanded="false">
                                    <?php echo e($reserch_c->research_centre_name); ?>

                                </a>
                                <?php elseif($reserch_c->url): ?>
                                <!-- Redirect to URL -->
                                <a class="dropdown-item" href="<?php echo e($reserch_c->url); ?>" target="_blank"
                                    aria-expanded="false">
                                    <?php echo e($reserch_c->research_centre_name); ?>
                                ...
                                <a class="dropdown-item"
                                    href="<?php echo e(url('lbsnaa-sub/' . $reserch_c->research_centre_slug)); ?>"
                                    aria-expanded="false">
                                    <?php echo e($reserch_c->research_centre_name); ?>
                    ...
                    <li class="nav-item <?php echo e(renderMenuItems($menu->id, in_array($menu->menu_slug, ['training', 'training_hi'])) ? 'dropdown' : ''); ?>">
                        ...
                        <a class="nav-link <?php echo e(renderMenuItems($menu->id, in_array($menu->menu_slug, ['training', 'training_hi'])) ? 'dropdown-toggle' : ''); ?>"
                                href="<?php echo e($url); ?>" target="<?php echo e($target); ?>" aria-expanded="false"
                                aria-label="Expanded <?php echo e($menu->menutitle); ?>">
                                <?php echo e($menu->menutitle); ?>

                                </a>

                                <?php echo renderMenuItems($menu->id, in_array($menu->menu_slug, ['training', 'training_hi'])); ?>
    ...
    </nav><?php /**PATH C:\xampp1\htdocs\lbsnaa-website\resources\views/user/includes/header.blade.php ENDPATH**/ ?>