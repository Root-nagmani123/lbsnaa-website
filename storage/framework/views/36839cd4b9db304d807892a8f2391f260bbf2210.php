                ...
                <table class="table align-middle" id="myTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <!-- <td><?php echo e(str_replace(['<p>', '</p>'], '', $centre->description)); ?></td> -->
                            <td><?php echo e(strip_tags($centre->description)); ?></td>
                            ...
                            <td>
                                <div class="d-flex flex-column flex-sm-row gap-2">
                                    ...
                                    <form action="<?php echo e(route('researchcentres.destroy', $centre->id)); ?>" method="POST" style="display:inline;">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>
                                        <button type="submit"
                                            class="btn btn-sm btn-primary text-white w-auto d-flex align-items-center justify-content-center"
                            ...
                            <td>
                                <div class="form-check form-switch">
                                    <input class="form-check-input status-toggle" type="checkbox" role="switch"
                                        data-table="research_centres" data-column="status" data-id="<?php echo e($centre->id); ?>"
                                        <?php echo e($centre->status ? 'checked' : ''); ?>>
                                </div>
                            </td>
                        </tr>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/hardeep/public_html/lbsnaa-website/resources/views/admin/micro/manage_researchcentre/index.blade.php ENDPATH**/ ?>