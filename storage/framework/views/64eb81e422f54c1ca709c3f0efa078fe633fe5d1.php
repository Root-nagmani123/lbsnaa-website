...
<section class="py-2">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-3 text-end">
            <a href="<?php echo e(route('user.tenders_archive')); ?>" class="btn btn-outline-primary fw-semibold btn-sm">Archive</a>
        </div>
    </div> 
</section>
        <!-- Tenders Card -->
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <?php if(!empty($value->file)): ?>
                                                <a href="<?php echo e(asset('storage/tender/'.$value->file)); ?>" class="btn btn-sm btn-outline-primary" target="_blank">Download</a>
                                            <?php else: ?>
...
<?php echo $__env->make('user.includes.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lbsnaa-website\resources\views/user/pages/tenders.blade.php ENDPATH**/ ?>