            ...
            <table width="100%" border="0" cellspacing="0" align="center" cellpadding="4" class="dataTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e(\Carbon\Carbon::parse($value->publish_date)->format('d F, Y')); ?></td>
                        <td><?php echo e(\Carbon\Carbon::parse($value->expiry_date)->format('d F, Y')); ?></td>
                        <td>
                            <?php if(!empty($value->document_upload)): ?>
                            <a href="<?php echo e(asset('uploads/' . $value->document_upload)); ?>" target="_blank">Download</a>
...
<?php echo $__env->make('user.includes.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp5\htdocs\lbsnaa_website\resources\views/user/pages/vacancy.blade.php ENDPATH**/ ?>