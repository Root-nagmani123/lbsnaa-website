...
<div class="card bg-white border-0 rounded-10 mb-4">
    <div class="card-body p-4">
        <div class="d-sm-flex text-center justify-content-between align-items-center border-bottom pb-20 mb-20">
            ...
            <a href="<?php echo e(route('souvenir.create')); ?>">
    ...
    <?php endif; ?>
        <div class="default-table-area members-list recent-orders">
            <div class="table-responsive">
                ...
                <td><?php echo e($loop->iteration); ?></td> <!-- Auto-incrementing index -->
                    ...
                    <td><?php echo e($category->category_name_hindi); ?></td>
                            <td>
                                <a href="<?php echo e(route('souvenir.edit', $category->id)); ?>"
                                    class="btn btn-success text-white btn-sm">Edit</a>
                                <form action="<?php echo e(route('souvenir.destroy', $category->id)); ?>" method="POST"
            ...
            data-column="status" data-id="<?php echo e($category->id); ?>" <?php echo e($category->status ? 'checked' : ''); ?>>
          </div></td>
                        </tr>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lbsnaa-website\resources\views/admin/souvenirModule/index.blade.php ENDPATH**/ ?>