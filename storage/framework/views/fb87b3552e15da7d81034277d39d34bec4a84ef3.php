                    ...
                    <form action="<?php echo e(route('micromenu.update', $menu->id)); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                                        ...
                                        <div class="form-group position-relative">
                                            <select class="form-select form-control ps-5 h-58" name="research_centre"
                                                ...
                                                <option value="" disabled
                                                    <?php echo e(is_null($menu->research_centreid) ? 'selected' : ''); ?>>Select
                                        ...
                                        <div class="form-group mb-0">
                                            ...
                                            <div class="form-group position-relative">
                                                <textarea class="form-control ps-5 text-dark" placeholder="Some demo text ... " cols="30" rows="5"
                                                    name="content" id="content"><?php echo e($menu->content); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-4">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="form-group position-relative">
                                                <select class="form-select form-control ps-5 h-58" name="web_site_target"
                                                    ...
                                                    <option
                                                        class="text-dark"<?php echo e($menu->menucategory == 0 ? 'selected' : ''); ?>>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <select class="form-select form-control ps-5 h-58" id="menu_status"
                                            ...
                                            <option value="2" class="text-dark"
                                                <?php echo e($menu->menu_status == 2 ? 'selected' : ''); ?>>Inactive</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex ms-sm-3 ms-md-0">
                                ...
                                <a href="<?php echo e(route('micromenus.index')); ?>" class="btn btn-secondary text-white">Cancel</a>
                            </div>
                        </div>
                    </form>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lbsnaa-website\resources\views/admin/micro/manage_micromenus/edit.blade.php ENDPATH**/ ?>