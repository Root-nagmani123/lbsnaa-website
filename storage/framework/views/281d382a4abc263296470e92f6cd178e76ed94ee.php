                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                'jpg', 'jpeg'])): ?>
                                <img src="<?php echo e(asset('/storage/tender/' . $tender->file)); ?>" alt="Uploaded File"
                                    width="100">
                                <?php elseif($tender->file): ?>
                                <a href="<?php echo e(asset('/storage/tender/' . $tender->file)); ?>" target="_blank">View File</a>
                                <?php else: ?>
                                No file uploaded
                                <?php endif; ?>
                            </td>
                            ...
                            <td>
                                <button type="button"
                                    ...
                                    data-title="<?php echo e($tender->title); ?>" data-type="<?php echo e($tender->type); ?>"
                                    data-publish_date="<?php echo e(date('Y-m-d h:i A', strtotime($tender->publish_date))); ?>"
                                    data-expiry_date="<?php echo e(date('Y-m-d h:i A', strtotime($tender->expiry_date))); ?>"
                                    data-description="<?php echo e($tender->description); ?>"
                                    data-image="<?php echo e(asset('/storage/tender/' . $tender->file)); ?>"
