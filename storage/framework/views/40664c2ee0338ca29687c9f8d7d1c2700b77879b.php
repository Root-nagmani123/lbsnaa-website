    ...
    <div class="container-fluid">
        <div class="row gy-4">
                ...
                <div class="mb-3">
                    <div class="card card-hover border">
                        <div class="card-header" style="background-color:#af2910">
                            <h1 class="text-white h4"><?php if(Cookie::get('language') == '2'): ?>
                                अकादमी समाचार
                                <?php else: ?>
                                LBSNAA Academy News
                                <?php endif; ?> <span class="float-end"><a href="<?php echo e(route('user.news_listing')); ?>"
                                        class="text-white"
                                        style="text-decoration: none;font-size:14px" aria-label="View All Academy News"><?php if(Cookie::get('language') == '2'): ?>
                                        सभी को देखें
                                        <?php else: ?>
                                        View All
                                        <?php endif; ?></a></span></h1>
                                    ...
                                    <div class="card">
                                        <div class="card-header p-0 border-0">
                                            <img src="<?php echo e(isset($slider->main_image) && !empty($slider->main_image) ? asset($slider->main_image) : asset('assets/images/4.jpg')); ?>"
                                                class="card-img-top img-fluid" alt="<?php echo e($slider->title); ?>"
                                        ...
                                        <div class="card-footer border-0" style="height:50px;">
                                            <a href="<?php echo e(route('user.newsbyslug', $slider->title_slug)); ?>"
                                                class="icon-link icon-link-hover link-primary fw-semibold" aria-label="Read More <?php echo e($slider->title); ?>">
                                                <span>
                                                    <?php if(Cookie::get('language') == '2'): ?>
                                                    और पढ़ें
                                                    <?php else: ?>
            ...
            <div class="col-12 col-md-3">
                ...
                <div class="card card-hover border">
                    <div class="card-header" style="background-color:#af2910">
                        <h4 class="text-white"><?php if(Cookie::get('language') == '2'): ?> त्वरित लिंक्स <?php else: ?> Quick Links
                            <?php endif; ?></h4>
                    </div>
