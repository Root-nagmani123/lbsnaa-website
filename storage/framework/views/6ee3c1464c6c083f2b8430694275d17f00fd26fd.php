...
<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="false">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item <?php echo e($key == 0 ? 'active' : ''); ?>">
            <img src="<?php echo e(asset('slider-images/' . $slider->image)); ?>" class="d-block w-100 img-fluid"
                alt="<?php echo e($slider->text); ?>" style="object-fit: cover;">
                    ...
                    <div id="marqueeContainer" class="d-flex gap-3">
                        ...
                        <a href="<?php echo e(route('user.letest_updates', $scroller->menu_slug)); ?>"
                            ...
                            <div class="py-3 gap-3">
                                <h6 class="mb-0"><?php echo e($scroller->menutitle); ?></h6>
                            </div>
                        </a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
        ...
        <div class="row gy-4 gy-xl-0">
            <div class="col-md-2 col-12 mb-4">
                <div class="card card-lift text-center text-lg-start h-100">
                    <div class="p-2">
                        <img src="<?php echo e(asset('assets/images/icons/1.jpg')); ?>" alt="" class="img-fluid rounded-3 w-100 "
                                            ...
                                            <div class="card-body" style="height: 200px; overflow-y: hidden;">
                                                ...
                                                <h3>
                                                    <a href="<?php echo e(route('user.newsbyslug', $slider->title_slug)); ?>"
                                                        class="text-inherit"><?php echo e($slider->title); ?></a>
                                                </h3>
