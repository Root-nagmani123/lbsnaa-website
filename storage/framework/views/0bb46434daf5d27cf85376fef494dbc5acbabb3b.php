                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <select class="form-select form-control ps-5 h-58" name="support_section"
                                        ...
                                        <option value="1" class="text-dark" <?php echo e($course->support_section == 1 ? 'selected' : ''); ?>>First</option>
                                        <option value="2" class="text-dark" <?php echo e($course->support_section == 2 ? 'selected' : ''); ?>>Second</option>
                                        <option value="3" class="text-dark" <?php echo e($course->support_section == 3 ? 'selected' : ''); ?>>Tgird</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <select class="form-select form-control ps-5 h-58" name="course_type"
                                        ...
                                        <option value="1" class="text-dark" <?php echo e($course->course_type == 1? 'selected' : ''); ?>>First</option>
                                        <option value="2" class="text-dark" <?php echo e($course->course_type == 2? 'selected' : ''); ?>>Second</option>
                                        <option value="3" class="text-dark" <?php echo e($course->course_type == 3? 'selected' : ''); ?>>Tgird</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <select class="form-select form-control ps-5 h-58" name="venue_id" id="venue_id"
                                        required>
                                        <option value="1" class="text-dark" <?php echo e($course->venue_id == 1? 'selected' : ''); ?>>First</option>
                                        <option value="2" class="text-dark" <?php echo e($course->venue_id == 2? 'selected' : ''); ?>>Second</option>
                                        <option value="3" class="text-dark" <?php echo e($course->venue_id == 3? 'selected' : ''); ?>>Tgird</option>
                                    </select>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lbsnaa-website\resources\views/admin/courses/edit.blade.php ENDPATH**/ ?>