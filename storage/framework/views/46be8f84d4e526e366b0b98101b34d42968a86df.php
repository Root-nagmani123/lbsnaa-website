                ...
                <table class="table align-middle" id="myTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="<?php echo e(asset('storage/' . $slider->slider_image)); ?>" width="100"></td>
                            <td><?php echo e($slider->slider_text); ?></td>
                            <!-- <td><?php echo e(html_entity_decode(strip_tags($slider->slider_description))); ?></td> -->
                            <td>
                                <?php if($slider->language == 1): ?>
                                English
                                <?php elseif($slider->language == 2): ?>
                                Hindi
                                <?php endif; ?>
                            </td>
                            <td>
                                <button type="button" class="btn btn-outline-primary fw-semibold btn-sm view-slider"
                                    ...
                                    data-text="<?php echo e($slider->slider_text); ?>"
                                    data-description="<?php echo e($slider->slider_description); ?>"
                                    data-image="<?php echo e(asset('storage/' . $slider->slider_image)); ?>"
                            ...
                            <td>
                                <div class="form-check form-switch">
                                    <input class="form-check-input status-toggle" type="checkbox" role="switch"
                                        data-table="micro_sliders" data-column="status" data-id="<?php echo e($slider->id); ?>"
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lbsnaa-website\resources\views/admin/micro/slider/index.blade.php ENDPATH**/ ?>