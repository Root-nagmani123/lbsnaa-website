        ...
        <div class="card bg-white border-0 rounded-10 mb-4">
            <div class="card-body p-4">
                ...
                <form action="<?php echo e(route('organisation_chart.update', $record->id)); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <input type="hidden" name="parent_id" value="<?php echo e($record->parent_id); ?>">
                        <!-- Page Language -->
                        <div class="col-lg-6">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp11\htdocs\lbsnaa-website\resources\views/admin/manage_organisationchart/edit.blade.php ENDPATH**/ ?>