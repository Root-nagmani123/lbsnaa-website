                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-start align-items-start gap-2">
                                    <a href="<?php echo e(route('survey.edit', $record->id)); ?>"
                                        class="btn btn-success text-white btn-sm">
                                        Edit
                                    </a>
                                    <form action="<?php echo e(route('survey.destroy', $record->id)); ?>" method="POST"
                                        class="m-0">
                                        <?php echo csrf_field(); ?>
                            ...
                            <td>
                                <div class="form-check form-switch">
                                    <input class="form-check-input status-toggle" type="checkbox" role="switch"
                                        data-table="manage_surveys" data-column="status" data-id="<?php echo e($record->id); ?>"
