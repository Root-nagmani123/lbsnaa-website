                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="form-group position-relative">
                                            <input type="radio" name="txtlanguage" value="1" <?php echo e($menu->txtlanguage == '1' ? 'checked' : ''); ?>> English
                                            <input type="radio" name="txtlanguage" value="2" <?php echo e($menu->txtlanguage == '2' ? 'checked' : ''); ?>> Hindi
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <select class="form-select form-control ps-5 h-58"
                                            ...
                                            <option value="1" class="text-dark" <?php echo e($menu->texttype == 1 ? 'selected' : ''); ?>>Content</option>
                                            <option value="2" class="text-dark" <?php echo e($menu->texttype == 2 ? 'selected' : ''); ?>>PDF file Upload</option>
                                            <option value="3" class="text-dark" <?php echo e($menu->texttype == 3 ? 'selected' : ''); ?>>Web Site Url</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="form-group position-relative">
                                                <input type="text" class="form-control text-dark ps-5 h-58" name="meta_title"
                                                    id="meta_title" value="<?php echo e($menu->meta_title); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group mb-0">
                                            ...
                                            <div class="form-group position-relative">
                                                <textarea class="form-control ps-5 text-dark"
                                                    ...
                                                    name="meta_description" id="meta_description"><?php echo e($menu->meta_description); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="form-group position-relative">
                                                <select class="form-select form-control ps-5 h-58" name="web_site_target"
                                                    ...
                                                    <option class="text-dark"<?php echo e($menu->menucategory == 0 ? 'selected' : ''); ?>>It is Root Category</option>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <select class="form-select form-control ps-5 h-58" id="txtpostion" name="txtpostion" required>
                                            <option class="text-dark">Select</option>
                                            <option value="1" class="text-dark" <?php echo e($menu->txtpostion == 1 ? 'selected' : ''); ?>>Header Menu</option>
                                            <option value="2" class="text-dark" <?php echo e($menu->txtpostion == 2 ? 'selected' : ''); ?>>Bottom Menu</option>
                                            <option value="3" class="text-dark" <?php echo e($menu->txtpostion == 3 ? 'selected' : ''); ?>>Footer Menu</option>
                                            <option value="4" class="text-dark" <?php echo e($menu->txtpostion == 4 ? 'selected' : ''); ?>>Director Message Menu</option>
                                            <option value="5" class="text-dark" <?php echo e($menu->txtpostion == 5 ? 'selected' : ''); ?>>Life Academy Menu</option>
                                            <option value="6" class="text-dark" <?php echo e($menu->txtpostion == 6 ? 'selected' : ''); ?>>Other Pages</option>
                                            <option value="7" class="text-dark" <?php echo e($menu->txtpostion == 7 ? 'selected' : ''); ?>>Latest Updates</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <select class="form-select form-control ps-5 h-58" id="menu_status" name="menu_status" required>
                                            <option class="text-dark">Select</option>
                                            <option value="1" class="text-dark" <?php echo e($menu->menu_status == 1 ? 'selected' : ''); ?>>Active</option>
                                            <option value="0" class="text-dark" <?php echo e($menu->menu_status == 0 ? 'selected' : ''); ?>>Inactive</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp5\htdocs\lbsnaa_website\resources\views/admin/menus/edit.blade.php ENDPATH**/ ?>