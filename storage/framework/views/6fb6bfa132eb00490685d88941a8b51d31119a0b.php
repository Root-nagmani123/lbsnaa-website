                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <div class="text-start">
                                <a href="#" data-bs-toggle="modal"
                                    data-bs-target="#organizationModal<?php echo e($organization->id); ?>"
                                        ...
                                        <table class="table table-borderless">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><?php echo e($organization->employee_name ?? ''); ?></td>
                                                </tr>
                                                <tr>
                                                    <th class="col">Designation :-</th>
                                                    <td><?php echo e($organization->designation ?? ''); ?></td>
                                                </tr>
                                                <tr>
...
<?php echo $__env->make('user.pages.microsites.includes.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/hardeep/public_html/lbsnaa-website/resources/views/user/pages/microsites/organizations.blade.php ENDPATH**/ ?>