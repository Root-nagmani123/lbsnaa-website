...
<div class="row justify-content-center">
    <div class="col-lg-12">
        ...
        <?php endif; ?>
                <form action="<?php echo e(route('micro_manage_vacancy.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        ...
                        <div class="d-flex ms-sm-3 ms-md-0">
                            ...
                            <a href="<?php echo e(route('micro_manage_vacancy.index')); ?>" class="btn btn-secondary text-white">Cancel</a>
                        </div>
                    </div>
                </form>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lbsnaa-website\resources\views/admin/micro/micro_manage_vacancy/create.blade.php ENDPATH**/ ?>