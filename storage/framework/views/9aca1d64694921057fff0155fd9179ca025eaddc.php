...
<div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <span class="star">*</span>
                                <div class="form-group position-relative">
                                    <input type="date" class="form-control text-dark ps-5 h-58" name="exm_date" id="exm_date" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lbsnaa-website\resources\views/admin/manage_exam/create.blade.php ENDPATH**/ ?>