                ...
                <table class="table align-middle" id="myTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e(\Carbon\Carbon::parse($exam->transaction_date)->format('d-m-Y')); ?></td>
                            <td>
                            ...
                            <td>
                                <div class="form-check form-switch">
                                    <input class="form-check-input status-toggle" type="checkbox" role="switch"
                                        data-table="manage_exam" data-column="status" data-id="<?php echo e($exam->id); ?>"
                                        <?php echo e($exam->status ? 'checked' : ''); ?>>
                                </div>
                            </td>
                        </tr>
