                    ...
                    <div class="row">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="text" class="form-control text-dark ps-5 h-58" name="product_title"
                                        id="product_title" value="<?php echo e($souvenir->product_title); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <input type="file" class="form-control text-dark ps-5 h-58" name="document_upload"
                                            id="document_upload" value="<?php echo e($souvenir->document_upload); ?>">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="file" class="form-control text-dark ps-5 h-58" name="upload_image"
                                        id="upload_image" value="<?php echo e($souvenir->upload_image); ?>">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                        <textarea name="product_description" id="product_description" rows="3" class="form-control text-dark"><?php echo e($souvenir->product_description); ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
