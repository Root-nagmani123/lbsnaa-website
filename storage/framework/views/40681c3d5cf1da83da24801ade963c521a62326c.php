                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="radio" name="language" value="1" <?php echo e($souvenir->language == '1' ? 'checked' : ''); ?>> English
                                    <input type="radio" name="language" value="2" <?php echo e($souvenir->language == '2' ? 'checked' : ''); ?>> Hindi
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <select class="form-select form-control ps-5 h-58" name="product_category" id="product_category"
                                        ...
                                        <option value="<?php echo e($category->id); ?>" class="text-dark" <?php echo e($souvenir->product_category == $category->id ? 'selected' : ''); ?>><?php echo e($category->category_name); ?></option>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="text" class="form-control text-dark ps-5 h-58" name="product_title"
                                        id="product_title" value="<?php echo e($souvenir->product_title); ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <select class="form-select form-control ps-5 h-58" name="product_type" id="product_type"
                                        ...
                                        <option value="Sale" class="text-dark" <?php echo e($souvenir->product_type == 'Sale' ? 'selected' : ''); ?>>Sale</option>
                                        <option value="Download" class="text-dark" <?php echo e($souvenir->product_type == 'Download' ? 'selected' : ''); ?>>Download</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <input type="number" class="form-control text-dark ps-5 h-58" name="product_price"
                                            id="product_price" step="0.01" value="<?php echo e($souvenir->product_price); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <input type="number" class="form-control text-dark ps-5 h-58" name="product_discounted_price"
                                            id="product_discounted_price" step="0.01" value="<?php echo e($souvenir->product_discounted_price); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <input type="email" class="form-control text-dark ps-5 h-58" name="contact_email_id"
                                            id="contact_email_id" value="<?php echo e($souvenir->contact_email_id); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <input type="file" class="form-control text-dark ps-5 h-58" name="document_upload"
                                            id="document_upload" required value="<?php echo e($souvenir->document_upload); ?>">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="file" class="form-control text-dark ps-5 h-58" name="upload_image"
                                        id="upload_image" required value="<?php echo e($souvenir->upload_image); ?>">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <span class="star">*</span>
                                <div class="form-group position-relative">
                                        <textarea name="product_description" id="product_description" rows="3" required class="form-control text-dark"><?php echo e($souvenir->product_description); ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <select class="form-select form-control ps-5 h-58" name="product_status" id="product_status"
                                        required>
                                        <option value="1" class="text-dark" <?php echo e($souvenir->product_status == 1 ? 'selected' : ''); ?>>Active</option>
                                        <option value="0" class="text-dark" <?php echo e($souvenir->product_status == 0 ? 'selected' : ''); ?>>Inactive</option>
                                    </select>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lbsnaa-website\resources\views/admin/souvenirModule/academy_souvenirs/edit.blade.php ENDPATH**/ ?>