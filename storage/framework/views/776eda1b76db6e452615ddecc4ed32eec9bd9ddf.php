    ...
    <div class="container-fluid">
        <div class="row gy-4 gy-xl-0">
            <div class="col-md-2 col-12 mb-4">
                <div class="card card-lift text-center text-lg-start h-100">
                    ...
                    <div class="card-body pt-2" style=" height: 100px;">
                        ...
                        <a href="<?php echo e(url('menu/director-message')); ?>"
                            class="icon-link icon-link-hover link-primary">Message</a> <br>
                        <a href="<?php echo e(url('menu/previous-directors')); ?>"
            ...
            <div class="col-md-2 col-12 mb-4">
                <div class="card card-lift text-center text-lg-start h-100">
                    <div class="p-3 p-lg-4 text-center">
                        <a href="#"><img src="<?php echo e(asset('assets/images/icons/3.jpg')); ?>" alt=""
            ...
            <div class="col-md-2 col-12 mb-4">
                <div class="card card-lift text-center text-lg-start h-100">
                    <div class="p-3 p-lg-4 text-center">
                        <a href="#"><img src="<?php echo e(asset('assets/images/icons/4.jpg')); ?>" alt=""
            ...
            <div class="col-md-2 col-12 mb-4">
                <div class="card card-lift text-center text-lg-start h-100">
                    <div class="p-3 p-lg-4 text-center">
                        <a href="#"><img src="<?php echo e(asset('assets/images/icons/2.jpg')); ?>" alt=""
                                class="avatar avatar-xl rounded-circle text-center" style="object-fit: cover;"></a>
                    </div>
                    <div class="card-body pt-2" style="height: 100px;">
                        <h4 class="mb-3">Training Calendar</h4>
                        <a href="<?php echo e(url('cms/training_cal')); ?>" class="icon-link icon-link-hover link-primary">Training
            ...
            <div class="col-md-2 col-12 mb-4">
                <div class="card card-lift text-center text-lg-start h-100">
                    <div class="p-3 p-lg-4 text-center">
                        <a href="#"><img src="<?php echo e(asset('assets/images/icons/5.jpg')); ?>" alt=""
                                class="avatar avatar-xl rounded-circle text-center" style="object-fit: cover;"></a>
                    </div>
                    <div class="card-body pt-2" style="height: 100px;">
            ...
            <div class="col-md-2 col-12 mb-4">
                <div class="card card-lift text-center text-lg-start h-100">
                    <div class="p-3 p-lg-4 text-center">
                        <a href="#"><img src="<?php echo e(asset('assets/images/icons/6.jpg')); ?>" alt=""
                                class="avatar avatar-xl rounded-circle text-center" style="object-fit: cover;"></a>
                    </div>
                    <div class="card-body pt-2" style="height: 100px;">
                    ...
                    <div class="card card-hover border">
                        <div class="card-header" style="background-color:#af2910">
                            <h3 class="text-white">LBSNAA Academy News <span class="float-end"><a
                                        href="<?php echo e(route('user.news_listing')); ?>" class="text-white"
                                ...
                                <div class="col-lg-4 col-md-6 col-12 mb-4">
                                    <div class="card">
                                        ...
                                        <div class="card-body" style="height: 200px; overflow-y: hidden;">
                                            ...
                                            <h3><a href="<?php echo e(route('user.newsbyslug', $slider->title_slug)); ?>" class="icon-link icon-link-hover link-dark fw-semibold"><?php echo e($slider->title); ?></a></h3>
